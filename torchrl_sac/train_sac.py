...
def main(cfg: DictConfig):  # noqa: F821
    ...
    for i in range(total_iter):
        ...
        if abs(collected_frames % 100000) < frames_per_batch:
            #replay_buffer.dumps(f"./replay_buffer_{collected_frames}.pt")
            torch.save(model.state_dict(), f"sac_{collected_frames}.pt")
